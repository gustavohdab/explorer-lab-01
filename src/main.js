...
function setCardType(type){
    const colors = {
        ...
        americanexpress: ["#2DCFF2", "#113A64"],
        discover: ["#997743", "#997643"],
        diners: ["#F3F6FF", "#007BFC"],
        unionpay: ["#F22D2D", "#00447C"],
        maestro: ["#2D65F2", "#994343"],
        jcb: ["#F2512D", "#549943"],
        jcb15: ["#304F2B", "#435B99"],
        default: ["black", "gray"],
    }
...
cardHolder.addEventListener("input", () => {
    ...
    ccHolder.innerText = cardHolder.value.length === 0 ? "Your name" : cardHolder.value
})
...
cardNumberMasked.on("accept", () => {
    ...
    upateCardNumber(cardNumberMasked.value)
    console.log(cardtype);
})

function upateCardNumber(number) {
